  ...
  return (
    <div className={cn("flex flex-wrap items-end justify-between gap-4 pb-6", className)}>
      <div className="min-w-0">
        {eyebrow && (
          <div className="mb-1 text-[11px] font-semibold uppercase tracking-[0.08em] text-mute-slate">
            {eyebrow}
          </div>
        )}
        ...
        {description && <p className="mt-1 max-w-2xl text-[14px] text-mute-slate">{description}</p>}
      </div>
